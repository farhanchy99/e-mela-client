...
const Header = () => {
    ...
    const menus= <React.Fragment>
        ...
        <>
        <li className='ml-5'><NavLink to='/addproducts'>Add Products</NavLink></li>
        <li className='ml-5'><NavLink to='/myproducts'>My Products</NavLink></li>
        </>
        : 
        <>
        ...
        <div className='bg-green-500'>
            <div className="container navbar m-auto px-4 lg:px-20">
                ...
                <div className="navbar-end">
                    <NavLink className="hidden lg:block mr-5">{user?.displayName}</NavLink>
