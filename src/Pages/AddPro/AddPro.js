    ...
    return (
        <div>
            ...
            <form onSubmit={handlePro}>
                <div className='card-body w-4/5 lg:w-1/2 bg-base-100 shadow-2xl rounded-lg m-auto my-10'>
                    <div className='w-1/2'>
                    ...
                    <div className="form-control">
                        <input name="proImg" type="url" placeholder="Photo URL" className="input input-bordered w-full backdrop-blur-sm bg-white/30" required/>
                    </div>
